...
export class EmailService {
  ...
  private emails: EmailItem[] = [
    ...
    { id: '3', subject: ' Offer', sender: 'offers@example.com', body: 'Check out our special offers just for you.' },
    { id: '4', subject: 'Special ', sender: 'offers@example.com', body: 'Check out our special offers just for you.' },
    { id: '5', subject: 'Bank', sender: 'offers@example.com', body: 'Check out our special offers just for you.' },
    { id: '6', subject: 'Managment', sender: 'offers@example.com', body: 'Check out our special offers just for you.' },
    { id: '7', subject: 'Privit', sender: 'offers@example.com', body: 'Check out our special offers just for you.' },
